...
<body>
    ...
    <div id="map"></div> <!-- Conteneur pour la carte -->
        <div id="topRightSquare"><img src="images/personnes.png" id="clickableImage"> 
    </div>
    ...
    <div class="bike-option">
        <img src="images/bike_me.png" alt="Vélo mécanique" class="bike-logo">
        <label>
            Vélo mécanique</br>
    ...
    <div class="bike-option">
        <img src="images/bike_el.png" alt="Vélo électrique" class="bike-logo">
        <label>
            Vélo électrique</br>
...
const imageSrc = 'images/personnes.png'; // Lien de l'image à suivre
...
function submitSelection() {
    ...
    const selectedBike = document.querySelector('input[name="bike-type"]:checked');
        ...
        showErrorPopup(`<p style="margin: 0px;">Merci, votre réservation a été confirmée !</p>
                        ...
                        fetch('http://localhost/api_files/post_order.php', {
        method: 'POST',
        headers: {
...
function sendData(searchs,bool,staionID) {
        ...
        fetch('http://localhost/api_files/post_search.php', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
